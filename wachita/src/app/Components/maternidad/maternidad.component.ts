...
@Component({
  selector: 'app-maternidad',
  templateUrl: './maternidad.component.html',
  styleUrls: ['./maternidad.component.css']
})
export class MaternidadComponent implements OnInit,AfterViewInit{
